        ...
        return (
          <div key={i} className="flex justify-between items-center gap-3 mb-1.5 last:mb-0">
            <div className="flex items-center gap-1.5">
              ...
              <span className="font-semibold text-theme-text-muted dark:text-theme-text-dark-muted">{label}</span>
            </div>
            <span className="font-bold text-theme-text-main dark:text-theme-text-dark-main">{entry.value}</span>
          </div>
        )
      })}
    </div>
