...
export const CardHeader = ({ title, children }: { title: string, children?: React.ReactNode }) => (
  <div className="bg-gradient-to-r from-theme-primary to-theme-secondary px-4 py-2 flex justify-between items-center w-full relative z-10">
    <h3 className="text-[12px] font-bold text-theme-text-dark-main tracking-wider">{title}</h3>
