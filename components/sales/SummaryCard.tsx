      ...
      <div className="p-5 grid grid-cols-12 gap-6">
            ...
            <div className="flex-1 min-h-0">
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={lineData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                        ...
                        <Line type="monotone" dataKey="lastYear" name="Geçen Dönem" stroke="#f4a261" strokeWidth={2} dot={false} />
                        <Line type="monotone" dataKey="budget" name="Bütçe" stroke="#9ca3af" strokeWidth={2} dot={false} strokeDasharray="5 5" />
                        <Line type="monotone" dataKey="actual" name="Fiili" stroke="#1B8D98" strokeWidth={3} activeDot={{ r: 6 }} dot={{ r: 3, fill: '#1B8D98', stroke: '#fff', strokeWidth: 2 }} />
                    </LineChart>
                </ResponsiveContainer>
            </div>
        </div>
        ...
        <div className="col-span-12 lg:col-span-3 h-80 flex flex-col border-t lg:border-t-0 lg:border-l border-dashed border-slate-200 dark:border-slate-700/50 pt-6 lg:pt-0 lg:pl-6">
            ...
            <div className="flex-1 min-h-0 mb-4">
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={barData} margin={{ top: 20, right: 0, left: -20, bottom: 0 }} barSize={20}>
                        <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#e5e7eb" strokeOpacity={0.5} />
                        <XAxis dataKey="name" axisLine={false} tickLine={false} tick={{fill: '#64748b', fontSize: 8, fontWeight: 600}} dy={5} interval={0} />
