...
export const THEME_COLORS = {
  ...
  success: "#029664ff",      // Emerald Green (Standart kurumsal başarı rengi)
...
export const INCOME_STATEMENT_DATA: IncomeRow[] = [
  { id: 'qty', name: 'Satış Miktarı (Ton)', current: 12450, share: 0, budgetVar: 2.1, yearVar: 5.4, level: 0, isHeader: true },

  { id: 'gross', name: 'Brüt Satışlar', current: 850000, share: 115, budgetVar: 4.2, yearVar: 12.1, level: 0, isHeader: true },
  { id: 'returns', name: 'Satış İadeleri', current: -25000, share: -3.4, budgetVar: -1.2, yearVar: 2.5, level: 1 },
  { id: 'discounts', name: 'Satış ve Peşinat İskontoları', current: -15000, share: -2.1, budgetVar: 0.5, yearVar: -1.1, level: 1 },

  { id: 'net', name: 'Net Satışlar', current: 810000, share: 100, budgetVar: 3.8, yearVar: 11.5, level: 0, isHeader: true },
  { id: 'prod_sales', name: 'Üretim Satışları', current: 600000, share: 74.1, budgetVar: 4.0, yearVar: 10.2, level: 1 },
  { id: 'service_sales', name: 'Hizmet Satışları', current: 50000, share: 6.2, budgetVar: 1.2, yearVar: 5.5, level: 1 },
  { id: 'trade_sales', name: 'Ticari Mal Satışları', current: 150000, share: 18.5, budgetVar: 5.1, yearVar: 15.8, level: 1 },
  { id: 'other_rev', name: 'Diğer Gelirler', current: 10000, share: 1.2, budgetVar: -2.0, yearVar: 1.0, level: 1 },

  { id: 'cogs', name: 'Satılan Malın Maliyeti', current: -450000, share: -55.6, budgetVar: -2.5, yearVar: -8.4, level: 0, isHeader: true },
  { id: 'raw_mat', name: 'Hammadde+Yard.Malz. Giderleri', current: -250000, share: -30.9, budgetVar: -1.5, yearVar: -5.2, level: 1 },
  { id: 'packaging', name: 'Ambalaj Giderleri', current: -80000, share: -9.9, budgetVar: -3.2, yearVar: -12.1, level: 1 },
  { id: 'energy', name: 'Enerji Giderleri', current: -40000, share: -4.9, budgetVar: -5.0, yearVar: -15.4, level: 1 },
  { id: 'labor', name: 'İşçilik Giderleri', current: -50000, share: -6.2, budgetVar: -1.0, yearVar: -4.5, level: 1 },
  { id: 'overhead', name: 'Diğer Genel Üretim Giderleri', current: -20000, share: -2.5, budgetVar: 0.5, yearVar: 2.1, level: 1 },
  { id: 'amort', name: 'Amortisman Giderleri', current: -10000, share: -1.2, budgetVar: 0.0, yearVar: 0.0, level: 1 },

  { id: 'gross_profit', name: 'Brüt Satış Karı', current: 360000, share: 44.4, budgetVar: 5.5, yearVar: 15.2, level: 0, isHeader: true },
  { id: 'gross_profit_no_amort', name: 'Brüt Satış Karı (Amort. Hariç)', current: 370000, share: 45.7, budgetVar: 5.4, yearVar: 15.0, level: 1 },

  { id: 'opex', name: 'Faaliyet Giderleri', current: -150000, share: -18.5, budgetVar: -1.8, yearVar: -6.5, level: 0, isHeader: true },
  { id: 'rd', name: 'Arge Giderleri', current: -5000, share: -0.6, budgetVar: 0.0, yearVar: 5.0, level: 1 },
  { id: 'marketing_dist', name: 'Paz. Satış ve Dağ. Giderleri', current: -100000, share: -12.3, budgetVar: -2.5, yearVar: -8.0, level: 1 },
  { id: 'admin', name: 'Genel Yönetim Giderleri', current: -45000, share: -5.6, budgetVar: -0.5, yearVar: -3.2, level: 1 },

  { id: 'ebit', name: 'EBIT', current: 210000, share: 25.9, budgetVar: 8.2, yearVar: 28.5, level: 0, isHeader: true },
  { id: 'ebitda', name: 'EBITDA', current: 220000, share: 27.2, budgetVar: 8.0, yearVar: 27.8, level: 0, isHeader: true },

  { id: 'finance', name: 'Finansman Giderleri', current: -30000, share: -3.7, budgetVar: -5.5, yearVar: -12.0, level: 1 },
  { id: 'other_ops', name: 'Diğer Faal. Doğan Gider (+)/Gelir (-)', current: 5000, share: 0.6, budgetVar: 10.0, yearVar: 50.0, level: 1 },

  { id: 'period_profit', name: 'Dönem Karı', current: 185000, share: 22.8, budgetVar: 6.5, yearVar: 22.4, level: 0, isHeader: true },
  { id: 'tax', name: 'Vergi Karşılıkları', current: -40000, share: -4.9, budgetVar: 0.0, yearVar: -5.0, level: 1 },

  { id: 'net_profit', name: 'Dönem Net Karı', current: 145000, share: 17.9, budgetVar: 8.4, yearVar: 29.5, level: 0, isHeader: true },
];
