...
export const INCOME_STATEMENT_DATA: IncomeRow[] = [
  { id: 'gross_sales', name: '1. BRÜT SATIŞ TUTARI', current: 719502256, share: 122.4, budgetVar: 4.2, yearVar: 12.1, level: 0, isHeader: true },
  { id: 'prod_sales', name: '1.1. Üretimden Satışlar', current: 696380388, share: 123.3, budgetVar: 2.5, yearVar: 8.4, level: 1 },
  { id: 'gross_sales_detail', name: '1.1.1. Brüt Satış', current: 696898389, share: 123.4, budgetVar: 1.8, yearVar: 7.2, level: 2 },
  { id: 'tender_diff', name: '1.1.2. İhale Fiyat Farkı (-)', current: -518001, share: 0.1, budgetVar: 0.5, yearVar: 1.2, level: 2 },
  { id: 'other_income', name: '1.2. Diğer Gelirler', current: 23121868, share: 100.0, budgetVar: 6.2, yearVar: 15.1, level: 1 },

  { id: 'sales_returns', name: '2. Satış İadeleri', current: -4422593, share: 0.6, budgetVar: -1.2, yearVar: 2.5, level: 0, isHeader: true },
  { id: 'sales_ret_prod', name: '2.1. Üretimden Satışlar', current: -4422593, share: 0.6, budgetVar: -1.2, yearVar: 2.5, level: 1 },
  { id: 'sales_ret_detail', name: '2.1.1. Satış İadeleri', current: -4422593, share: 0.6, budgetVar: -1.2, yearVar: 2.5, level: 2 },

  { id: 'discounts', name: '3. Satış ve Peşinat İskontoları', current: -127115447, share: 17.8, budgetVar: -2.1, yearVar: 0.5, level: 0, isHeader: true },
  { id: 'disc_prod', name: '3.1. Üretimden Satışlar', current: -127115447, share: 18.4, budgetVar: -2.1, yearVar: 0.5, level: 1 },
  { id: 'disc_wholesale', name: '3.1.1. Toptancı İskontosu', current: -122556750, share: 17.7, budgetVar: -1.8, yearVar: 0.2, level: 2 },
  { id: 'disc_promo', name: '3.1.2. Promosyon', current: -4543531, share: 0.66, budgetVar: -0.2, yearVar: 0.1, level: 2 },
  { id: 'disc_price_off', name: '3.1.3. Price Off', current: -4849, share: 0.0, budgetVar: -0.1, yearVar: 0.0, level: 2 },
  { id: 'disc_other', name: '3.1.4. Diğer İskontolar', current: -10318, share: 0.0, budgetVar: 0.0, yearVar: 0.2, level: 2 },

  { id: 'net_sales', name: '4. NET SATIŞ TUTARI', current: 587964216, share: 100.0, budgetVar: 5.1, yearVar: 14.5, level: 0, isHeader: true },

  { id: 'cogs', name: '5. Satışların Maliyeti (COGS)', current: -516755706, share: 87.9, budgetVar: -4.5, yearVar: -10.2, level: 0, isHeader: true },
  { id: 'cogs_raw', name: '5.1. Hammadde Giderleri', current: -290784663, share: 51.5, budgetVar: -2.1, yearVar: -5.4, level: 1 },
  { id: 'cogs_aux', name: '5.2. Yardımcı Malzeme Giderleri', current: -17020042, share: 3.0, budgetVar: -0.5, yearVar: -1.2, level: 1 },
  { id: 'cogs_pkg', name: '5.3. Ambalaj Giderleri', current: -70314009, share: 12.4, budgetVar: -1.1, yearVar: -2.0, level: 1 },
  { id: 'cogs_var_prod', name: '5.4. Değişken Üretim Gideri', current: -28888445, share: 5.1, budgetVar: -0.4, yearVar: -0.8, level: 1 },
  { id: 'cogs_fixed_prod', name: '5.5. Sabit Üretim Gideri', current: -109748547, share: 19.4, budgetVar: 0.2, yearVar: 0.5, level: 1 },
  { id: 'cogs_dir_labor', name: '5.6. Direkt İşçilik Giderleri', current: -55875321, share: 9.9, budgetVar: -0.5, yearVar: -1.6, level: 1 },
  { id: 'cogs_indir_labor', name: '5.7. Endirekt İşçilik Giderleri', current: -18968205, share: 3.4, budgetVar: 0.1, yearVar: -0.3, level: 1 },
  { id: 'cogs_machine', name: '5.8. Makina Giderleri', current: -11603799, share: 2.1, budgetVar: 0.0, yearVar: -0.2, level: 1 },
  { id: 'cogs_deprec', name: '5.9. Amortisman Giderleri', current: -13917604, share: 2.5, budgetVar: 0.0, yearVar: 0.1, level: 1 },
  { id: 'cogs_other_prod', name: '5.10. Diğer Genel Üretim Giderleri', current: -9383619, share: 1.7, budgetVar: -0.2, yearVar: 0.7, level: 1 },

  { id: 'gross_margin', name: '6. BRÜT SATIŞ KARI veya ZARARI', current: 71208509, share: 12.6, budgetVar: 8.2, yearVar: 25.4, level: 0, isHeader: true },

  { id: 'rnd', name: '7. Ar-Ge Giderleri', current: -7148500, share: 1.3, budgetVar: -0.5, yearVar: 0.2, level: 0, isHeader: true },

  { id: 'marketing_sales_dist', name: '8. Pazarlama, Satış ve Dağıtım Giderleri', current: -36711502, share: 6.5, budgetVar: -1.2, yearVar: -3.4, level: 0, isHeader: true },
  { id: 'msd_storage', name: '8.1. Depolama Gideri', current: -12398062, share: 2.2, budgetVar: -0.4, yearVar: -0.8, level: 1 },
  { id: 'msd_dispatch', name: '8.2. Sevkiyat Gideri', current: -3153473, share: 0.6, budgetVar: -0.1, yearVar: -0.5, level: 1 },
  { id: 'msd_freight', name: '8.3. Nakliye Gideri', current: -2073278, share: 0.4, budgetVar: 0.0, yearVar: -0.2, level: 1 },
  { id: 'msd_export', name: '8.4. İhracat Gideri', current: -6186812, share: 1.1, budgetVar: -0.2, yearVar: -1.1, level: 1 },
  { id: 'msd_other', name: '8.5. Diğer Satış Gideri', current: -10190340, share: 1.8, budgetVar: -0.3, yearVar: -0.6, level: 1 },
  { id: 'msd_marketing', name: '8.6. Pazarlama Harcamaları', current: -2709538, share: 0.5, budgetVar: -0.2, yearVar: -0.2, level: 1 },
  { id: 'msd_mk_direct', name: '8.6.1. Doğrudan Pazarlama', current: -843216, share: 0.1, budgetVar: -0.1, yearVar: 0.0, level: 2 },
  { id: 'msd_mk_edt', name: '8.6.2. EDT Pazarlama', current: -286654, share: 0.1, budgetVar: 0.0, yearVar: 0.1, level: 2 },
  { id: 'msd_mk_trade', name: '8.6.3. Ticari Pazarlama', current: -76372, share: 0.0, budgetVar: 0.0, yearVar: 0.0, level: 2 },
  { id: 'msd_mk_export', name: '8.6.4. İhracat Pazarlama', current: -1454372, share: 0.3, budgetVar: -0.1, yearVar: -0.3, level: 2 },
  { id: 'msd_mk_corp', name: '8.6.5. Kurumsal İletişim Pazarlama', current: -48924, share: 0.0, budgetVar: 0.0, yearVar: 0.0, level: 2 },

  { id: 'gen_admin', name: '9. Genel Yönetim Giderleri', current: -28776520, share: 5.1, budgetVar: -1.5, yearVar: -2.8, level: 0, isHeader: true },

  { id: 'operating_expenses', name: '10. Faaliyet Giderleri', current: -72636522, share: 12.9, budgetVar: -3.2, yearVar: -6.0, level: 0, isHeader: true },

  { id: 'ebit', name: '11. EBIT', current: -1428013, share: -0.3, budgetVar: -1.5, yearVar: -2.1, level: 0, isHeader: true },

  { id: 'ebitda', name: '12. EBITDA', current: 17588926, share: 3.1, budgetVar: 5.0, yearVar: 19.4, level: 0, isHeader: true },

  { id: 'contribution', name: '13. KATKI PAYI', current: 176192916, share: 31.2, budgetVar: 10.4, yearVar: 35.8, level: 0, isHeader: true },
];
